...
class ClientRegistrationForm(BaseForm):
    ...
    fields = [
        FormField(
            ...
            title="ПІБ",
            kind="text",
            prompt="👤 Введіть ваше ПІБ:<code>Петро Петрович</code>",
        ...
        FormField(
            ...
            title="Телефон",
            kind="text",
            prompt="📞 Введіть номер телефону:<code>0689384811</code>",
        ...
        FormField(
            ...
            title="Компанія",
            kind="text",
            prompt="🏢 Назва компанії:<code>TOV Intertrade</code>",
            allow_skip=False,
        ),
        FormField(
            name="tax_id",
            title="ЄДРПОУ/ІПН",
            kind="text",
            prompt="🆔 ЄДРПОУ (8 цифр) або ІПН (10 цифр):<code>12345678</code>",
        ...
        FormField(
            ...
            title="Адреса",
            kind="text",
            prompt="📍 Адреса офісу:<code>IF</code>",
            allow_skip=False,
        ),
        FormField(
            name="website",
            title="Сайт",
            kind="text",
            prompt="🌐 Сайт компанії (або пропустіть):<code>https://google.com</code>",
            allow_skip=True,
        ),
    ]
